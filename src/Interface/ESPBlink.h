...
class ESPBlink : public ESPLedInterface {
  ...
  public:
	 ...
	 *                  0 < interval
	 *
	 * @param duration  The time in milliseconds for the LED to stay on when it
	 * blinks 0 < duration
	 *
	 * post: duration() == duration, interval() == interval, isStarted() ==
	 * false
	 */
	 ...
	 *
	 * TODO need to make indices less confusing... theyre supposed to be
	 * backwards here
	 *
